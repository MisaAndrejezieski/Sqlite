    ...
    def __init__(self, db_nome):
        ...
        self.c.execute('''
            CREATE TABLE IF NOT EXISTS produtos (
                ...
                taxa_de_producao REAL NOT NULL
            )
        ''')
...
class Aplicativo:
    def __init__(self, gerenciador):
        ...
        self.label_taxa_de_producao = ttk.Label(self.frame_botoes, text="Taxa de Produção (Kg/hora):")
        self.label_taxa_de_producao.pack(side=tk.LEFT)
        self.entry_taxa_de_producao = ttk.Entry(self.frame_botoes)
        self.entry_taxa_de_producao.pack(side=tk.LEFT)
    ...
    def atualizar_lista(self):
        ...
        for produto in produtos:
            id, nome, quantidade, taxa_de_producao = produto
            self.listbox.insert(tk.END, f"ID: {id}, Nome: {nome}, Quantidade: {quantidade}, Taxa de Produção: {taxa_de_producao}")
